...
exports.createUsers = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                nuevoUsuario = typeorm_1.getRepository(User_1.User).create(req.body);
                return [4 /*yield*/, typeorm_1.getRepository(User_1.User).save(nuevoUsuario)];
            case 1:
                results = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, typeorm_1.getRepository(User_1.User).findOne(req.body.id)];
            case 1:
                usuario = _a.sent();
            ...
            case 2:
                results = _a.sent();
                return [2 /*return*/, res.json(results)];
            case 3: return [2 /*return*/, res.status(200).send('No Se Encontro el registro para actualizar')];
        }
    });
}); };
